...
namespace NetFusion.RabbitMQ.Plugin.Configs
{
    ...
    {
        /// <summary>
        /// Determines if RabbitMQ logs should be forwarded to Microsoft's
        /// base ILogger.  If not specified, the underlying EasyNetQ library
        /// will automatically forward logs if one of the supported loggers
