...
public class HalResource : IResource
{
    ...
    public object GetModel() => _modelValue ?? throw new NullReferenceException("Resource Model not Set");
    ...
    {
        _modelValue = modelValue ?? throw new ArgumentNullException(nameof(modelValue));
    }
    ...
    // -- Methods for creating resource instances --

    /// <summary>
    /// Creates a new HAL Resource with no associated model to which other
