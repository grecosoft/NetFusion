...
public interface IApiMetadataService
{
    ...
    bool TryGetActionMeta(string httpMethod, string relativePath, [MaybeNullWhen(false)]out ApiActionMeta actionMeta);
    ...
    /// <param name="actionMeta">Reference to the controller action metadata if found.</param>
    /// <returns>True if the controller metadata is found.  Otherwise, false.</returns>
    bool TryGetActionMeta(MethodInfo methodInfo, [MaybeNullWhen(false)]out ApiActionMeta actionMeta);
