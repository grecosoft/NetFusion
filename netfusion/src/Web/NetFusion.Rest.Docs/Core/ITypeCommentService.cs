...
{
    /// <summary>
    /// Service responsible for building  documentation for a
    /// specific type based on an underlying source.
    /// </summary>
    public interface ITypeCommentService
    {
        /// <summary>
        /// Returns documentation for a controller action resource type.
        /// </summary>
