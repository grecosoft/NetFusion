...
using NetFusion.Services.Roslyn.Plugin.Modules;

namespace NetFusion.Services.Roslyn.Plugin;
...
public class RoslynPlugin : PluginBase
{
    ...
    public RoslynPlugin()
    {
        ...
        SourceUrl = "https://github.com/grecosoft/NetFusion/tree/master/src/Common/NetFusion.Services.Roslyn";
