...
namespace NetFusion.Services.Roslyn.Plugin.Modules;
...
public class ExpressionModule : PluginModule
{
    ...
    private IEnumerable<EntityScript> _scripts = Enumerable.Empty<EntityScript>();
    ...
    protected override async Task OnRunModuleAsync(IServiceProvider services)
    {
        ...
        var scriptingSrv = services.GetRequiredService<IEntityScriptingService>();
