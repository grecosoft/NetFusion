...
public class MessageSerializationTests
{
    ...
    public void DomainEvent_UsingMessagePack_SerializesCorrectly()
    {
        ...
        var newDomainEvent = (TestDomainEvent)serializer.Deserialize(data, typeof(TestDomainEvent));

        newDomainEvent.Should().NotBeNull();
        newDomainEvent!.TestProp1.Should().Be(domainEvent.TestProp1);
    ...
    public void Command_UsingMessagePack_SerializesCorrectly()
    {
        ...
        var newCommand = (TestCommand)serializer.Deserialize(data, typeof(TestCommand));
