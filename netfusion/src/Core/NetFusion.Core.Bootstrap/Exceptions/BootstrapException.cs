...
namespace NetFusion.Core.Bootstrap.Exceptions;

/// <summary>
/// Exception thrown by the container when there is an issue bootstrapping the application.
/// </summary>
public class BootstrapException : NetFusionException
{
    /// <summary>
    /// Default Constructor.
    /// </summary>
    ...
    public BootstrapException(string message, string? exceptionId = null) 
    ...
    /// <param name="exceptionId">Optional value used to identity the exception.</param>
    public BootstrapException(string message, Exception innerException, string? exceptionId = null)
    ...
    /// <param name="exceptionId">Optional value used to identity the exception.</param>
    public BootstrapException(string message, string detailKey, object details, string? exceptionId = null)
