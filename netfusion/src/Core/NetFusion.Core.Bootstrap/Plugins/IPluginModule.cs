...
public interface IPluginModule 
{
    ...
    /// </summary>
    public PropertyInfo[] DependentServiceProperties { get; set; }
    ...
    /// </summary>
    public IDictionary<PropertyInfo, Tuple<Type, Type[]>> KnownTypeProperties { get; } 

    /// <summary>
    /// Sets the context containing plugin context information.
    /// </summary>
    /// <param name="context">The context of the plugin</param>
