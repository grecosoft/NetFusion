namespace NetFusion.Bootstrap.Plugins
{
    ...
    public enum PluginTypes
    {
        ...
        /// 
        /// [Solution.Domain]    - The domain models, commands, queries, and domain-events.
        ///                      - This plugin assembly should contain no dependencies on other plugins.
        /// 
        /// [Solution.App]       - Contains command, query, and domain-event handlers.  Also contains service
        ///                          implementations. This plugin assembly should only reference the assembly of
        ///                          of the domain plugin.
        ///
        /// [Solution.Infra]     - Contains repository implementations.  Also contains any implementation
