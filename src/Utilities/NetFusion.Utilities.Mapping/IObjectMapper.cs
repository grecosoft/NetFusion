namespace NetFusion.Utilities.Mapping
{
    ...
    public interface IObjectMapper
    {
        ...
        /// </summary>
        /// <typeparam name="TTarget">The type to which the source type should be mapped.  
        /// This can also be a base of the target type associated with the mapping strategy.
        /// When a base type is used, a source type can be mapped to a derived target type
        /// based on the source type.</typeparam>
        /// <param name="source">The source type to be mapped.</param>
