...
namespace NetFusion.Messaging.Modules
{
    ...
    public interface IMessagingModule : IPluginModuleService
    {
        ...
        /// <summary>
        /// A lookup by message types used to find the dispatch
        /// information for all consumer message handlers that should 
        /// be invoked for a given type of message
        /// </summary>
        ILookup<Type, MessageDispatchInfo> MessageTypeDispatchers { get; }
    }
}
